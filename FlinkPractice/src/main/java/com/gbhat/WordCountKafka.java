...
/*
    ...
    To submit the job to flink cluster:

    export JAVA_HOME=/home/guru/bin/jdk-11.0.15.1/
    export bin=$bin:$JAVA_HOME/bin/
    export java=$JAVA_HOME/bin/java
    alias java=$JAVA_HOME/bin/java
    ./gradlew clean build
    sudo docker cp build/libs/FlinkPractice-1.0-SNAPSHOT.jar jobmanager:/tmp/
    sudo docker exec -it $jobmanager_container_id bash
    bin/flink run -c com.gbhat.WordCountKafka /tmp/FlinkPractice-1.0-SNAPSHOT.jar
 */
